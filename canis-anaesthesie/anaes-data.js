...
window.ANAES = {
  ...
  drugs: [
    ...
    { id:'esmolol', name:'Esmolol', icon:'💓', cls:'Antiarrhythmikum (β1-Blocker, ultrakurz)',
      /* CliniPharm/vetpharm am 19.08.2026 selbst gelesen (Wirkstoff 000000010359): dort stehen
       * die eigene Rubrik "Ventrikulaere Tachykardie" fuer Hund UND Katze und die kumulative
       * Grenze "bis maximal 0,5 mg/kg", die hier bis dahin fehlte. */
      sources:['CliniPharm/vetpharm UZH (Fox 1999a/b, Strickland 1998a)','RECOVER 2024','JVECC 2021','Plumbs Veterinary Drug Handbook'],
      species:{
        hund:{low:0.1,high:0.5,unit:'mg/kg',route:'langsam IV über 1–5 min',conc:'10 mg/mL',indication:'Supraventrikuläre oder Sinustachykardie mit Kreislaufwirkung; ventrikuläre Tachykardie (eigene Rubrik bei vetpharm, Fox 1999b); in der Reanimation bei defibrillationsresistentem Rhythmus (RECOVER 2024: 0,5 mg/kg über 3–5 min, dann 50 µg/kg/min)',notes:'Dauertropf 25–200 µg/kg/min, in Schritten von 50 steigern. Halbwertszeit rund 9 min — die Wirkung ist wieder weg, bevor ein Schaden bleibt. Boluswiederholung frühestens alle 5 min, in der SUMME höchstens 0,5 mg/kg — darüber hinaus über den Dauertropf, nicht bolusweise (vetpharm, Fox 1999b).',caution:'Negativ inotrop: bei Hypotonie, Herzinsuffizienz, AV-Block und Bradykardie KONTRAINDIZIERT. Nicht bei ventrikulärem Ersatzrhythmus. Nicht mit einem α2-Agonisten stapeln.'},
        katze:{low:0.05,high:0.5,unit:'mg/kg',route:'langsam IV über 1 min',conc:'10 mg/mL',indication:'Supraventrikuläre Tachykardie bei normalem Blutdruck; ebenso ventrikuläre Tachykardie — vetpharm führt dafür bei der Katze eine eigene Rubrik (Fox 1999b)',notes:'50–500 µg/kg über 1 min, Dauertropf 50–200 µg/kg/min. Wegen der kurzen Wirkdauer bei eingeschränkter Pumpfunktion bevorzugt. Wiederholung frühestens alle 5 min, in der SUMME höchstens 0,5 mg/kg — danach über den Dauertropf weiterführen, nicht weiter bolusweise nachlegen (vetpharm, Fox 1999b).',caution:'Bei Hypotonie kontraindiziert. Bei HCM mit Ausflusstraktobstruktion nur unter Blutdruckkontrolle.'}
      }},
    ...
    { id:'lidocain_lok', name:'Lidocain (Lokalanästhesie)', icon:'💉', cls:'Lokalanästhetikum',
      sources:['BSAVA'],
      species:{
        maus:{low:2,high:4,unit:'mg/kg',route:'lokale Infiltration',conc:'10 mg/mL (1 %) - vor Anwendung verduennen, Zielkonzentration festlegen',indication:'Infiltration Schnittrand, Ringblock',notes:'Quelle: Illinois ACS (2-4 mg/kg, Anschlag 5-10 min, Dauer 1-2 h); Ohio State 2 mg/kg, Obergrenze 7 mg/kg.',caution:'Bei 25 g Maus sind 4 mg/kg nur 0,1 mg = 0,01 ml einer 1%igen Loesung. Ohne Verduennung ist eine toedliche Ueberdosis unvermeidbar.'},
        ratte:{low:2,high:4,unit:'mg/kg',route:'lokale Infiltration',conc:'10 mg/mL (1 %) - vor Anwendung verduennen, Zielkonzentration festlegen',indication:'Infiltration Schnittrand, Ringblock, Zahnextraktion',notes:'Quelle: Illinois ACS (2-4 mg/kg, Anschlag 5-10 min, Dauer 1-2 h); Ohio State nennt 2 mg/kg und Obergrenze 7 mg/kg.',caution:'Gesamtdosis 7 mg/kg nicht ueberschreiten. Unverduennt reicht bei 300 g Ratte schon ein Tropfen an die toxische Grenze.'},
        rennmaus:{low:1,high:7,unit:'mg/kg',route:'lokale Infiltration / Inzisionslinie',conc:'5 mg/mL (0,5 %) (aus 20 mg/mL (2 %) verduennt)',indication:'Duftdruesentumor-Exzision, Schwanzamputation nach Degloving, Ovarialzysten-OP',notes:'Quelle: UBC Rodent Local Anesthetic SOP (max. 7 mg/kg, 0,5 % verduennt).',caution:'Lokalanaesthesie ist bei der Rennmaus doppelt wertvoll, weil sie den Inhalationsbedarf und damit die Kreislaufdepression senkt. Trotzdem: Gesamtdosis strikt einhalten, Krampfschwelle dieser Art ist ohnehin niedrig.'},
        hamster:{low:1,high:7,unit:'mg/kg',route:'lokale Infiltration / Splash / Inzisionslinie',conc:'5 mg/mL (0,5 %) (aus 20 mg/mL (2 %) verduennt) - zwingend',indication:'Inzisionslinienblock, Backentaschenchirurgie, Duftdruesen-/Hautexzision, Zahnextraktion',notes:'Quelle: UBC Animal Care, Local Analgesia/Anesthesia for Adult Rodents SOP: 2 % Lidocain auf 0,5 % verduennen, Gesamtdosis 7 mg/kg nicht ueberschreiten. In der Kleinnagerchirurgie war beim Goldhamster Lidocain-Ergaenzung noetig, um Peritonealschnitte unter Ketamin/Xylazin schmerzf',caution:'7 mg/kg ist bei 100 g Hamster 0,7 mg = 0,14 mL der 0,5-%-Loesung. Ueberschreitung fuehrt zu Krampf und Herzstillstand. Bei Kombination mit Bupivacain die Gesamtmenge der Lokalanaesthetika addieren (Bupivacain max. 2 mg/kg).'},
    ...
    { id:'fentanyl', name:'Fentanyl', icon:'💊', cls:'Opioid (µ, kurz)',
      ...
      species:{
        maus:{low:25,high:50,unit:'mcg/kg',route:'SC/IP (als Teil der MMF-Kombination)',conc:'0,05 mg/mL (50 mcg/mL) - fuer die Maus verduennen, Zielkonzentration festlegen',indication:'Analgetische Komponente der vollstaendig antagonisierbaren Injektionsnarkose',notes:'Quelle: MMF-Maus 0,05 mg/kg = 50 mcg/kg (Fleischmann, Lab Anim 2016); niedriger dosiertes Schema 25 mcg/kg IP.',caution:'Starke Atemdepression, bei der Maus regelmaessig Hypoxie ohne Sauerstoffvorlage. Bei maennlichen C57BL/6 ist nach Fentanyl-Midazolam-Medetomidin eine akute obstruktive Uropathie beschrieben - Blase nach der Narkose kontrollieren. Antagonist'},
        ratte:{low:5,high:10,unit:'mcg/kg',route:'SC/IP (als Teil der MMF-Kombination)',conc:'0,05 mg/mL (50 mcg/mL) - fuer die Ratte verduennen, Zielkonzentration festlegen',indication:'Analgetische Komponente der vollstaendig antagonisierbaren Injektionsnarkose',notes:'Quelle: MMF-Protokoll Ratte 0,005 mg/kg = 5 mcg/kg (Albrecht BMC Vet Res 2014; GV-SOLAS-Schema).',caution:'Starke Atemdepression - nur mit Sauerstoffvorlage. Antagonist Naloxon 0,12 mg/kg SC; damit faellt aber auch die Analgesie weg, deshalb vorher ein NSAID oder Buprenorphin geben.'},
    ...
    { id:'naloxon', name:'Naloxon', icon:'🔄', cls:'Opioid-Antagonist',
      ...
      species:{
        ...
        kaninchen:{low:0.01,high:0.1,unit:'mg/kg',route:'IV/IM',conc:'0.4 mg/mL',indication:'Antagonisierung',notes:'Spanne bestaetigt (Fiorello 2013a; Hernandez-Divers 2001a).',caution:'Bei Nagern und Kaninchen nach WIRKUNG dosieren, nicht als feste Dosis: eine fixe Gabe kann ueberdosieren und ueber sympathomimetische Effekte (steigender peripherer Gefaesswiderstand) ein Lungenoedem ausloesen (Allen 2005a).'}
      }},
    ...
    { id:'meloxicam', name:'Meloxicam', icon:'🌡️', cls:'NSAID',
      ...
      species:{
        maus:{low:5,high:5,unit:'mg/kg',route:'SC/PO',conc:'5 mg/mL (Injektion) bzw. 1,5 mg/mL (Suspension)',indication:'Perioperative und chronische Analgesie',notes:'Quelle: Ohio State (5 mg/kg SC q12h bzw. PO q24h), Illinois ACS (5 mg/kg SC q24h). Die Maus braucht deutlich mehr mg/kg als die Ratte (dort 1-2 mg/kg).',caution:'Nicht bei Dehydratation, Hypotension oder Nierenschaden. Nicht mit einem zweiten NSAID oder mit Dexamethason kombinieren.'},
        ratte:{low:1,high:2,unit:'mg/kg',route:'SC/PO',conc:'5 mg/mL (Injektion) bzw. 1,5 mg/mL (Suspension)',indication:'Perioperative und chronische Analgesie, Entzuendung',notes:'Quelle: Ohio State (2 mg/kg SC/PO q24h), UW-Madison RARC (1 mg/kg SC q12-24h), Illinois ACS (1-2 mg/kg SC q24h).',caution:'Bei chronischer Nierenerkrankung - bei alten Ratten sehr haeufig - Dosis reduzieren oder meiden, immer erst Volumenstatus sichern. Nicht bei Hypotension geben.'},
  ...
  incidents: [
    ...
    { id:'tachykardie', name:'Tachykardie', icon:'💓', cls:'Kreislauf', color:'#ff8c6b', tag:'HF ↑', short:'Herzfrequenz zu hoch',
      ...
      drugs:[ {id:'fentanyl',low:null,high:null,unit:'mcg/kg',route:'IV',note:'Wenn Ursache Schmerz oder zu flache Narkose. Katze niedriger als Hund.'},
              ...
              {id:'buprenorphin',low:null,high:null,unit:'mg/kg',route:'IV/IM',note:'Fuer Heimtiere die belegte Opioid-Wahl: Fentanyl und Methadon fuehren fuer die meisten Kleinsaeuger gar keine Dosis, Buprenorphin schon (Plumb’s, WSAVA Pain). Langsamer Wirkeintritt (20–45 min) — intraoperativ beim Hund und der Katze bleibt Fentanyl das schnellere Mittel.'},
